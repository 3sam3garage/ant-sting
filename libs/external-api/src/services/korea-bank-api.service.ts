...
export class KoreaBankApiService {
  ...
  async fetchAverageExchangeRate(param: EcosSearchInterface) {
    const {
      code = '731Y004',
      subCode = '',
      interval = 'M',
    ...
    const url = `https://ecos.bok.or.kr/api/StatisticSearch/${this.apiKey}/json/kr/${skip}/${limit}/${code}/${interval}/${startDate}/${endDate}/${subCode}/0000100`;
