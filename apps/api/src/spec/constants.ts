...
Take time to understand the context and summarize the information.
...
3. summarize the expectations.
4. summarize financial statement of past. 
5. if information not related to financial statement is in 'financialStatement' field, move it to 'summaries' field.
...
1. Figure out what company is up to and what they are expecting.
2. base on current_date, distinguish expectation and past data from text.
3. figure out target price from text. (could be in dollar or won or yen)
4. figure out position from text. (BUY, SELL, HOLD)
